!(function (e, t) {
  ...
  var k =
    ...
    (function (e) {
      ...
      try {
        N.apply((D = O.call(x.childNodes)), x.childNodes),
  ...
  (x.filter = function (e, t, n) {
    ...
    x.fn.extend({
      ...
      is: function (e) {
        return !!j(this, "string" == typeof e && $.test(e) ? x(e) : e || [], !1)
          .length;
      },
    });
  var D,
      ...
      function (e, t) {
        x.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (N[e] || x.uniqueSort(o), H.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
                    ...
                    c = function () {
                      ...
                      if (!(t < r)) {
                        ...
                        (c =
                          ...
                          h(c)
                            ? o
                              ? c.call(e, s(r, n, P, o), s(r, n, M, o))
                              : (r++,
                                c.call(
                                  e,
                                  s(r, n, P, o),
                                  s(r, n, M, o),
                                  s(r, n, P, n.notifyWith)
                                ))
                            : (i !== P && ((a = void 0), (l = [e])),
                              (o || n.resolveWith)(a, l));
                      }
              ...
              return x
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, h(o) ? o : P, e.notifyWith)),
    ...
    x.extend({
      ...
      ready: function (e) {
        (!0 === e ? --x.readyWait : x.isReady) ||
          ((x.isReady = !0),
          (!0 !== e && --x.readyWait > 0) || W.resolveWith(g, [x]));
      },
    }),
    (x.ready.then = W.then),
  ...
  var se = function (e, t) {
    return (
      ...
      ("" === e.style.display && oe(e) && "none" === x.css(e, "display"))
    );
  };
  function ae(e, t, n, i) {
    var o,
  ...
  function be(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && x.inArray(r, i) > -1) o && o.push(r);
        ...
        ((c = oe(r)), (s = ye(u.appendChild(r), "script")), c && me(s), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (i = n(this, t)),
                this[t](),
                s !== (r = G.get(this, t)) || i ? G.set(this, t, !1) : (r = {}),
                s !== r)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && A(t, "input") && $e(t, "click", Te),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && A(t, "input") && $e(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function qe(e, t, n, i) {
    ...
    var o,
      ...
      g = t[0],
      y = h(g);
    if (y || (p > 1 && "string" == typeof g && !f.checkClone && Ee.test(g)))
      return e.each(function (o) {
        var r = e.eq(o);
        y && (t[0] = g.call(this, o, r.html())), qe(r, t, n, i);
      });
    if (
      p &&
      ...
      for (l = (a = x.map(ye(o, "script"), Le)).length; u < p; u++)
        (c = o),
          u !== v &&
            ((c = x.clone(c, !0, !0)), l && x.merge(a, ye(c, "script"))),
          n.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, x.map(a, He), u = 0; u < l; u++)
          (c = a[u]),
            ve.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : m(c.textContent.replace(je, ""), c, d));
    }
    return e;
  }
  function Pe(e, t, n) {
    for (var i, o = t ? x.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || x.cleanData(ye(i)),
        i.parentNode &&
  ...
  x.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = ye(a), i = 0, o = (r = ye(e)).length; i < o; i++)
          Oe(r[i], s[i]);
      if (t)
        if (n)
          for (r = r || ye(e), s = s || ye(a), i = 0, o = r.length; i < o; i++)
            Ne(r[i], s[i]);
        else Ne(e, a);
      return (
        (s = ye(a, "script")).length > 0 && me(s, !l && ye(e, "script")), a
      );
    },
    ...
    x.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (x.cleanData(ye(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (x.cleanData(ye(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return qe(
          ...
          function (t) {
            ...
            x.inArray(this, e) < 0 &&
              (x.cleanData(ye(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  function Ke(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += x.css(e, n + ne[s], !0, o)),
        i
          ? ("content" === n && (l -= x.css(e, "padding" + ne[s], !0, o)),
            "margin" !== n &&
  ...
  function Ze(e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && o) ||
        ...
        (r = a in e) && (s = e[a])),
      (s = parseFloat(s) || 0) +
        Ke(e, t, n || (o ? "border" : "content"), r, i, s) +
        "px"
    );
  }
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Xe(a)), (s = x.cssHooks[t] || x.cssHooks[a]), void 0 === n)
        )
  ...
  x.extend(x.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !p.noBubble && !v(i)) {
          for (
            l = p.delegateType || m, mt.test(l + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (a = s);
        ...
        return (
          ...
          o ||
            ...
            (c &&
              ...
              ((a = i[c]) && (i[c] = null),
              (x.event.triggered = m),
              t.isPropagationStopped() && f.addEventListener(m, wt),
              i[m](),
              t.isPropagationStopped() && f.removeEventListener(m, wt),
            ...
            u
              ? (f.ifModified &&
                  ((T = S.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[o] = T),
                  (T = S.getResponseHeader("etag")) && (x.etag[o] = T)),
                204 === t || "HEAD" === f.type
                  ? (k = "nocontent")
                  : 304 === t
                  ? (k = "notmodified")
                  : ((k = b.state), (p = b.data), (u = !(g = b.error))))
              : ((g = k), (!t && k) || ((k = "error"), t < 0 && (t = 0))),
            (S.status = t),
            (S.statusText = (n || k) + ""),
            u ? y.resolveWith(h, [p, k, S]) : y.rejectWith(h, [S, k, g]),
            S.statusCode(w),
            (w = void 0),
  ...
  x.ajaxSetup({
    ...
    x.each(["top", "left"], function (e, t) {
      x.cssHooks[t] = Fe(f.pixelPosition, function (e, n) {
        if (n)
          return (n = Re(e, t)), Me.test(n) ? x(e).position()[t] + "px" : n;
      });
    }),
  ...
  $(function () {
    $(".reviews__slider").slick({
      infinite: !1,
      responsive: [{ breakpoint: 876, settings: { adaptiveHeigt: !0 } }],
    });
    let e = $("#header"),
      t = $("#top"),
      n = t.innerHeight(),
    ...
    $(window).on("scroll load resize", function () {
      (n = t.innerHeight()),
        (i = $(this).scrollTop()),
        i > n ? e.addClass("fixed") : e.removeClass("fixed");
    }),
      $(".header__burger").on("click", function (e) {
        e.preventDefault(), $(".header__menu").toggleClass("open");
      }),
...
if (menuLinks.length > 0) {
  function onMenuLinkClick(e) {
    const t = e.target;
    if (t.dataset.scroll && document.querySelector(t.dataset.scroll)) {
      const n =
        document.querySelector(t.dataset.scroll).getBoundingClientRect().top +
        scrollY -
